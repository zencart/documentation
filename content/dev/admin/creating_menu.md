...
For developers targeting 1.5.7 and above, the [encapsulated plugin](/dev/plugins/encapsulated/) architecture is the new standard.  For details on SQL actions in encapsulated plugins, see [Plugin SQL Installation](/dev/plugins/encapsulated/sql_installation/). 

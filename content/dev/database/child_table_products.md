...
aliases:
  - /dev/code/child_table_products/
category: code
weight: 10
---

As an alternative to [adding a field](/dev/database/add_field_products/), you may wish to create a child table. 
...
Then you will need to [customize your template to display the new field](/dev/storefront/displaying_custom_fields/). 

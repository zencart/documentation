...
```
#773: 'NOTIFY_ADMIN_PROD_LISTING_ADD_ICON', $product, $additional_icons
...
```
#1105: 'NOTIFIER_ADMIN_ZEN_REMOVE_CATEGORY', array(), $category_id
#1266: 'NOTIFIER_ADMIN_ZEN_REMOVE_PRODUCT', array(), $product_id, $ptc
#1356: 'NOTIFIER_ADMIN_ZEN_PRODUCTS_ATTRIBUTES_DOWNLOAD_DELETE', array(), $product_id
#1368: 'NOTIFIER_ADMIN_ZEN_REMOVE_ORDER', array(), $order_id, $restock
#1584:  'NOTIFY_ZEN_GET_TAX_RATE_OVERRIDE', array( 'class_id' => $class_id, 'country_id' => $country_id, 'zone_id' => $zone_id ), $tax_rate 
#2025: 'FUNCTIONS_LOOKUPS_OPTION_NAME_NO_VALUES_OPT_TYPE', $opt_type, $test_var
#2061: 'ZEN_COPY_PRODUCTS_ATTRIBUTES_START', array('from' => (int)$products_id_from, 'to' => (int)$products_id_to)
#2074: 'ZEN_COPY_PRODUCTS_ATTRIBUTES_DELETE', (int)$products_id_to
#2156: 'ZEN_COPY_PRODUCTS_ATTRIBUTES_ADD', array('pID' => (int)$products_id_to, 'fields' => $products_copy_from->fields)
#2196: 'ZEN_COPY_PRODUCTS_ATTRIBUTES_UPDATE', array('pID' => (int)$products_id_to, 'fields' => $products_copy_from->fields)
#2205: 'ZEN_COPY_PRODUCTS_ATTRIBUTES_COMPLETE', array('from' => (int)$products_id_from, 'to' => (int)$products_id_to)
#2303: 'NOTIFIER_ADMIN_ZEN_DELETE_PRODUCTS_ATTRIBUTES', array(), $delete_product_id
#3294: 'NOTIFY_TEST_DOWNLOADABLE_FILE_EXISTS', $check_filename, $handler
#3669: 'NOTIFY_ZEN_ADMIN_INVALID_IP_DETECTED', $original_ip
...
#124: 'NOTIFY_MODULES_COPY_TO_CONFIRM_DUPLICATE', compact('products_id', 'dup_products_id')
#202: 'NOTIFY_MODULES_COPY_TO_CONFIRM_DUPLICATE', compact('products_id', 'dup_products_id')
...
```
#76: 'NOTIFY_MODULES_COPY_PRODUCT_CONFIRM_DUPLICATE_FIELDS', $product, $separately_updated_fields, $casted_fields
#149: 'NOTIFY_PRODUCT_MUSIC_COPY_TO_CONFIRM_DUPLICATE', compact('products_id', 'dup_products_id')
#227: 'NOTIFY_PRODUCT_MUSIC_COPY_TO_CONFIRM_DUPLICATE', compact('products_id', 'dup_products_id')

```

#### admin/includes/modules/product_music/update_product.php
```
#139: 'NOTIFY_PRODUCT_MUSIC_UPDATE_PRODUCT_END', array('action' => $action, 'products_id' => $products_id)

```

#### admin/includes/modules/update_product.php
```
#123: 'NOTIFY_MODULES_UPDATE_PRODUCT_END', array('action' => $action, 'products_id' => $products_id)
...
```
#161: 'OPTIONS_VALUES_MANAGER_DELETE_VALUE', array('value_id' => $value_id)
#473: 'OPTIONS_VALUES_MANAGER_DELETE_VALUES_OF_OPTIONNAME', array('current_products_id' => $current_products_id, 'remove_ids' => $remove_downloads_ids, 'options_id' => $options_id_from, 'options_values_id' => $options_values_values_id_from)

```

#### admin/orders.php
```
#73: 'NOTIFY_ADMIN_ORDER_PREDISPLAY_HOOK', $oID, $action
#247: 'NOTIFY_ADMIN_ORDERS_UPDATE_ORDER_START', $oID
#412: 'NOTIFY_ADMIN_ORDERS_DEFAULT_ACTION', $oID, $order
#527: 'NOTIFY_ADMIN_ORDERS_EDIT_BEGIN', $oID, $order
#563: 'NOTIFY_ADMIN_ORDERS_UPPER_BUTTONS', $oID, $left_side_buttons, $right_side_buttons
#605: 'NOTIFY_ADMIN_ORDERS_ADDRESS_FOOTERS', 'customer', $address_footer_suffix, $order->customer
#628: 'ADMIN_ORDERS_IP_LINKS', $lookup_ip, $whois_url
#653: 'NOTIFY_ADMIN_ORDERS_ADDRESS_FOOTERS', 'delivery', $address_footer_suffix, $order->delivery
#672: 'NOTIFY_ADMIN_ORDERS_ADDRESS_FOOTERS', 'billing', $address_footer_suffix, $order->billing
#724: <?php 'NOTIFY_ADMIN_ORDERS_PAYMENTDATA_COLUMN2', $oID, $order ?>
#876: 'NOTIFY_ADMIN_ORDERS_STATUS_HISTORY_EXTRA_COLUMN_HEADING', array(), $extra_headings
#930: 'NOTIFY_ADMIN_ORDERS_STATUS_HISTORY_EXTRA_COLUMN_DATA', $orders_history->fields, $extra_data
#967: 'NOTIFY_ADMIN_ORDERS_AFTER_STATUS_LISTING', $oID, $additional_content
#991: 'NOTIFY_ADMIN_ORDERS_ADDL_HISTORY_INPUTS', array()
#1013: 'NOTIFY_ADMIN_ORDERS_EXTRA_STATUS_INPUTS', $order, $extra_status_inputs
#1061: 'NOTIFY_ADMIN_ORDERS_EDIT_BUTTONS', $oID, $order, $extra_buttons
#1091: 'NOTIFY_ADMIN_ORDERS_MENU_LEGEND', array(), $extra_legends
#1150: 'NOTIFY_ADMIN_ORDERS_LIST_EXTRA_COLUMN_HEADING', array(), $extra_headings
#1189: 'NOTIFY_ADMIN_ORDERS_SEARCH_PARMS', $keywords, $search, $search_distinct, $new_fields, $new_table, $order_by
#1252: 'NOTIFY_ADMIN_ORDERS_SHOW_ORDER_DIFFERENCE', array(), $orders->fields, $show_difference, $extra_action_icons
#1313: 'NOTIFY_ADMIN_ORDERS_LIST_EXTRA_COLUMN_DATA', (isset($oInfo) ? $oInfo : array()), $orders->fields, $extra_data
#1389: 'NOTIFY_ADMIN_ORDERS_MENU_BUTTONS', $oInfo, $contents
#1456: 'NOTIFY_ADMIN_ORDERS_MENU_BUTTONS_END', (isset($oInfo) ? $oInfo : array()), $contents
...
```
#231: 'ADMIN_WHOSONLINE_IP_LINKS', $item, $additional_ipaddress_links, $whois_url
...
#230: 'NOTIFY_ORDER_QUERY_ADD_PRODUCT', $this->products[$index], $index
#236: 'NOTIFY_ORDER_AFTER_QUERY', IS_ADMIN_FLAG, $this->orderId
#242: 'ORDER_QUERY_ADMIN_COMPLETE', array('orders_id' => $this->orderId)
#250: 'NOTIFY_ORDER_CART_BEGINS'
#422: 'NOTIFY_ORDER_CART_AFTER_ADDRESSES_SET', '', $taxCountryId, $taxZoneId
#453: 'NOTIFY_ORDER_CART_ADD_PRODUCT_LIST', array('index'=>$index, 'products'=>$products[$i])
#490: 'NOTIFY_ORDER_CART_ADD_ATTRIBUTE_LIST', array('index'=>$index, 'subindex'=>$subindex, 'products'=>$products[$i], 'attributes'=>$attributes)
#521: 'NOTIFY_ORDER_CART_FINISHED'
#575: 'NOTIFY_ORDER_CART_EXTERNAL_TAX_RATE_LOOKUP', STORE_PRODUCT_TAX_BASIS, $products, $loop, $index, $taxCountryId, $taxZoneId, $taxRates
#602: 'NOTIFY_ORDER_CART_EXTERNAL_TAX_HANDLING', array(), $index, $taxCountryId, $taxZoneId
#612: 'NOTIFY_ORDER_CART_SUBTOTAL_CALCULATE', array('shown_price' => $shown_price)
#645: 'NOTIFY_ORDER_CART_EXTERNAL_TAX_DURING_ORDER_CREATE', array(), $zf_ot_modules
#656: 'NOTIFY_ORDER_CART_ORDERSTATUS'
#721: 'NOTIFY_ORDER_DURING_CREATE_ADDED_ORDER_HEADER', array_merge(array('orders_id' => $this->orderId, 'shipping_weight' => $_SESSION['cart']->weight), $sql_data_array), $this->orderId
#734: 'NOTIFY_ORDER_DURING_CREATE_ADDED_ORDERTOTAL_LINE_ITEM', $sql_data_array, $ot_insert_id
#761: 'NOTIFY_ORDER_DURING_CREATE_ADDED_ORDER_COMMENT', $sql_data_array, $osh_insert_id
#789: 'NOTIFY_ORDER_PROCESSING_STOCK_DECREMENT_INIT', array('i'=>$i), $this->products[$i], $i
#813: 'NOTIFY_ORDER_PROCESSING_STOCK_DECREMENT_BEGIN', $i, $stock_values
#840: 'NOTIFY_ORDER_PROCESSING_BESTSELLERS_UPDATE', array(), $this->products[$i], $i
#845: 'NOTIFY_ORDER_PROCESSING_STOCK_DECREMENT_END', $i
#874: 'NOTIFY_ORDER_DURING_CREATE_ADDED_PRODUCT_LINE_ITEM', array_merge(array('orders_products_id' => $order_products_id, 'i' => $i), $sql_data_array), $order_products_id
#876: 'NOTIFY_ORDER_PROCESSING_CREDIT_ACCOUNT_UPDATE_BEGIN'
#879: 'NOTIFY_ORDER_PROCESSING_ATTRIBUTES_BEGIN'
#957: 'NOTIFY_ORDER_DURING_CREATE_ADDED_ATTRIBUTE_LINE_ITEM', array_merge(array('orders_products_attributes_id' => $opa_insert_id), $sql_data_array), $opa_insert_id
#971: 'NOTIFY_ORDER_DURING_CREATE_ADDED_ATTRIBUTE_DOWNLOAD_LINE_ITEM', $sql_data_array, $opd_insert_id
#977: 'NOTIFY_ORDER_PROCESSING_ATTRIBUTES_EXIST', $attributes_exist
#979: 'NOTIFY_ORDER_DURING_CREATE_ADD_PRODUCTS', $i, $custom_insertable_text
#1007: 'NOTIFY_ORDER_PROCESSING_ONE_TIME_CHARGES_BEGIN', $i
#1031: 'NOTIFY_ORDER_AFTER_ORDER_CREATE_ADD_PRODUCTS'
#1044: 'NOTIFY_ORDER_SEND_EMAIL_INITIALIZE', array(), $zf_insert_id, $order_totals, $zf_mode
#1048: 'NOTIFY_ORDER_SEND_LOW_STOCK_EMAILS'
#1093: 'NOTIFY_ORDER_EMAIL_BEFORE_PRODUCTS', array(), $email_order, $html_msg
#1157: 'NOTIFY_ORDER_SET_ORDER_MESSAGE'
#1179: 'NOTIFY_ORDER_INVOICE_CONTENT_READY_TO_SEND', array('zf_insert_id' => $zf_insert_id, 'text_email' => $email_order, 'html_email' => $html_msg), $email_order, $html_msg, $send_customer_email
#1200: 'NOTIFY_ORDER_INVOICE_CONTENT_FOR_ADDITIONAL_EMAILS', $zf_insert_id, $email_order, $html_msg
#1207: 'NOTIFY_ORDER_AFTER_SEND_ORDER_EMAIL', $zf_insert_id, $email_order, $extra_info, $html_msg
...
#245: 'NOTIFIER_CART_ADD_CART_START', array(), $products_id, $qty, $attributes, $notify
#333: 'NOTIFIER_CART_ADD_CART_END', array(), $products_id, $qty, $attributes, $notify
#357: 'NOTIFIER_CART_UPDATE_QUANTITY_START', array(), $products_id, $quantity, $attributes
#433: 'NOTIFIER_CART_UPDATE_QUANTITY_END'
#447: 'NOTIFIER_CART_CLEANUP_START'
#465: 'NOTIFIER_CART_CLEANUP_END'
#480: 'NOTIFIER_CART_COUNT_CONTENTS_START'
#487: 'NOTIFIER_CART_COUNT_CONTENTS_END'
#500: 'NOTIFIER_CART_GET_QUANTITY_START', array(), $products_id
#502: 'NOTIFIER_CART_GET_QUANTITY_END_QTY', array(), $products_id
#505: 'NOTIFIER_CART_GET_QUANTITY_END_FALSE', $products_id
#516: 'NOTIFIER_CART_IN_CART_START', array(), $products_id
#518: 'NOTIFIER_CART_IN_CART_END_TRUE', array(), $products_id
#521: 'NOTIFIER_CART_IN_CART_END_FALSE', $products_id
#533: 'NOTIFIER_CART_REMOVE_START', array(), $products_id
#550: 'NOTIFIER_CART_REMOVE_END'
#558: 'NOTIFIER_CART_REMOVE_ALL_START'
#560: 'NOTIFIER_CART_REMOVE_ALL_END'
#614: 'NOTIFY_CART_CALCULATE_PRODUCT_PRICE', $products_id, $product->fields
#692: 'NOTIFY_CART_CALCULATE_ATTRIBUTE_PRICE', $products_id, $attribute_price->fields
#857: 'NOTIFY_CART_CALCULATE_ATTRIBUTE_WEIGHT', array('products_id' => $products_id, 'options_id' => $option), $attribute_weight->fields
#924: 'NOTIFY_CART_ATTRIBUTES_PRICE_START', $products_id
#943: 'NOTIFY_CART_ATTRIBUTES_PRICE_NEXT', $products_id, $attribute_price->fields
#1034: 'NOTIFY_CART_ATTRIBUTES_PRICE_ONETIME_CHARGES_START', $products_id
#1051: 'NOTIFY_CART_ATTRIBUTES_PRICE_ONETIME_CHARGES_NEXT', $products_id, $attribute_price->fields
#1112: 'NOTIFY_CART_ATTRIBUTES_WEIGHT_START', $products_id
#1127: 'NOTIFY_CART_ATTRIBUTES_WEIGHT_NEXT', $products_id, $attribute_weight_info->fields
#1160: 'NOTIFIER_CART_GET_PRODUCTS_START', array(), $check_for_valid_cart
#1174: 'NOTIFY_CART_GET_PRODUCTS_NEXT', $products_id, $products->fields
#1341: 'NOTIFIER_CART_GET_PRODUCTS_END', array(), $products_array
#1350: 'NOTIFIER_CART_SHOW_TOTAL_START'
#1352: 'NOTIFIER_CART_SHOW_TOTAL_END'
#1362: 'NOTIFIER_CART_SHOW_TOTAL_BEFORE_DISCOUNT_START'
#1364: 'NOTIFIER_CART_SHOW_TOTAL_BEFORE_DISCOUNT_END'
#1964: 'NOTIFIER_CART_OPTIONAL_ATTRIBUTE_ERROR_MESSAGE_HOOK', $_POST, $the_list
#2203: 'NOTIFY_CART_USER_ACTION', array(), $goto, $parameters
...
#199: 'NOTIFY_ATTRIBUTES_MODULE_SALEMAKER_DISPLAY_PRICE_PERCENTAGE', $products_options->fields, $product_info->fields, $products_options_display_price, $data_properties
#219: 'NOTIFY_ATTRIBUTES_MODULE_ORIGINAL_PRICE', $products_options->fields, $products_options_array, $products_options_display_price, $data_properties
#292: 'NOTIFY_ATTRIBUTES_MODULE_RADIO_SELECTED', $products_options->fields, $data_properties
#381: 'NOTIFY_ATTRIBUTES_MODULE_CHECKBOX_SELECTED', $products_options->fields, $data_properties
#514: 'NOTIFY_ATTRIBUTES_MODULE_FORMAT_VALUE', array_merge($products_options->fields, $products_options_names->fields), $data_properties, $field_disabled, $attributeDetailsArrayForJson
#553: 'NOTIFY_ATTRIBUTES_MODULE_BEFORE_ASSEMBLE_OUTPUTS', $products_options->fields, $data_properties, $inputFieldId, $field_disabled
#629: 'NOTIFY_ATTRIBUTES_MODULE_DEFAULT_SWITCH', $products_options_names->fields, $options_name, $options_menu, $options_comment, $options_comment_position, $options_html_id, $data_properties, $options_inputfield_id
#636: 'NOTIFY_ATTRIBUTES_MODULE_OPTION_BUILT', $products_options_names->fields, $options_name, $options_menu, $options_comment, $options_comment_position, $options_html_id, $options_attributes_image, $data_properties, $options_inputfield_id
#641: 'NOTIFY_ATTRIBUTES_MODULE_END', $prod_id, $options_name, $options_menu, $options_comment, $options_comment_position, $options_html_id, $options_attributes_image, $options_inputfield_id, $attributeDetailsArrayForJson
...
#94: 'NOTIFY_CHECKOUT_PROCESS_AFTER_ORDER_CREATE'
#96: 'NOTIFY_CHECKOUT_PROCESS_AFTER_PAYMENT_MODULES_AFTER_ORDER_CREATE'
#100: 'NOTIFY_CHECKOUT_PROCESS_AFTER_ORDER_CREATE_ADD_PRODUCTS'
#103: 'NOTIFY_CHECKOUT_PROCESS_AFTER_SEND_ORDER_EMAIL'
...
```
#180:  'NOTIFY_OT_COUPON_COUPON_REMOVED' 
#226:  'NOTIFY_OT_COUPON_COUPON_INFO', array( 'coupon_result' => $coupon_result->fields, 'code' => $dc_check ) 
#343: 'NOTIFY_OT_COUPON_USES_PER_USER_CHECK', $coupon_result->fields, $coupon_uses_per_user_exceeded
#619:  'NOTIFY_OT_COUPON_CALCS_FINISHED', array( 'coupon' => $coupon, 'order_totals' => $orderTotalDetails, 'od_amount' => $od_amount, ) 
#643:  'NOTIFY_OT_COUPON_PRODUCT_VALIDITY', array( 'is_product_valid' => $is_product_valid, 'i' => $i ) 
...
#134: 'NOTIFY_HEADER_END_ACCOUNT_NOTIFICATION'
...
```
#11: 'NOTIFY_HEADER_START_ASK_A_QUESTION'
#47: 'NOTIFY_ASK_A_QUESTION_CAPTCHA_CHECK', $_POST
#54: 'NOTIFY_SPAM_DETECTED_USING_CONTACT_US', $_POST
#74: 'NOTIFY_ASK_A_QUESTION_ACTION', (isset($_SESSION['customer_id']) ? $_SESSION['customer_id'] : 0), $customer_email, $customer_name, $email_address, $name, $enquiry, $telephone
#168: 'NOTIFY_HEADER_END_ASK_A_QUESTION'
...
#74: 'NOTIFY_LOGIN_BANNED'
#90: 'NOTIFY_PROCESS_3RD_PARTY_LOGINS', $email_address, $password, $loginAuthorized
#136: 'NOTIFY_LOGIN_SUCCESS'
#181: 'NOTIFY_LOGIN_FAILURE'
#193: 'NOTIFY_HEADER_END_LOGIN'
...
#88: 'NOTIFY_REVIEW_INSERTED_DURING_WRITE_REVIEW'
#101: 'NOTIFY_SEND_ADMIN_EMAIL_WRITE_REVIEW'
#113: 'NOTIFY_EMAIL_READY_WRITE_REVIEW'
...
#2594: 'NOTIFY_HEADER_ADDRESS_BOOK_ADD_ENTRY_INVALID_ATTEMPT', $customer_id, $country_id, $address_format_id, $address_question_arr
#2657: 'NOTIFY_HEADER_ADDRESS_BOOK_ADD_ENTRY_DONE', 'paypal express checkout', $new_address_book_id, $sql_data_array, $make_default
#2912: 'NOTIFY_PAYPALWPP_ERROR_HANDLER', $response, $operation, $basicError, $ignoreList, $errorInfo
...
#14: 'NOTIFY_MODULE_PRODUCT_LISTING_RESULTCOUNT', $listing_split->number_of_rows
#148: 'NOTIFY_MODULES_PRODUCT_LISTING_PRODUCTS_BUTTON', array(), $listing->fields, $lc_button
#216: 'NOTIFY_PRODUCT_LISTING_END', $current_page_base, $list_box_contents, $listing_split, $show_top_submit_button, $show_bottom_submit_button, $show_submit, $how_many
...
```
#265: 'NOTIFY_FOOTER_END', $current_page
...
```
#194: 'NOTIFY_FOOTER_END', $current_page

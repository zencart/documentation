...
If you're developing a plugin that uses an observer-class, you would traditionally have to provide ***two*** files in your plugin's distribution to get that class loaded and instantiated:
...
Here are the requirements (as pulled  from the file `/includes/init_includes/init_observers.php`):

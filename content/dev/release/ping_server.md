...
aliases:
  - /dev/release_process/ping_server/
weight: 70
layout: docs
category: release
---

Note: if you are doing a pre-release rather than an official release, please skip this step and go to the [next step](/dev/release/release_links/). 
...
<div style="text-align:right;" id="next">
   <a class="btn btn-lg btn-primary mr-3 mb-4" href="/dev/release/release_links/">

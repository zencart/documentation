...
aliases:
  - /dev/release_process/pre_release_notes/
weight: 5
layout: docs
category: release
---
...
If you are doing official release, please skip this step and go to the [next step](/dev/release/dependency_checks/). 
...
Here's what should be in these files for the (hypothetical) version 2.3.0 build:
...
<div style="text-align:right;" id="next">
   <a class="btn btn-lg btn-primary mr-3 mb-4" href="/dev/release/dependency_checks/">

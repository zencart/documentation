...
aliases:
  - /dev/release_process/dependency_checks/
weight: 10
layout: docs
category: release
---
...
Note that the license for mmenu changed in their v5.6.0 to CC-BY-NC-4.0, which is not compatible with Zen Cart's GPLv2 license. So we cannot distribute mmenu 5.6.0 or newer with Zen Cart. Bugfixes must be applied directly to current distro files instead.
...
<div style="text-align:right;" id="next">
   <a class="btn btn-lg btn-primary mr-3 mb-4" href="/dev/release/prerequisites/">

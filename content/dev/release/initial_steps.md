...
title: Initial Steps
aliases:
  - /dev/release_process/initial_steps/
weight: 30
layout: docs
category: release
---
...
There is a final piece of documentation which needs to be updated, and that is the [Implementation Guide](/dev/release/implementation_guide/).  This is delivered as part of the build, so it must be up to date before you do the build! 

<div style="text-align:right;" id="next">
   <a class="btn btn-lg btn-primary mr-3 mb-4" href="/dev/release/version_stamping/">

...
aliases:
  - /dev/release_process/version_stamping/
weight: 40
layout: docs
category: release
---
...
basic information about the release progress.  Update `/dev/release/release_log.md`.


<div style="text-align:right;" id="next">
   <a class="btn btn-lg btn-primary mr-3 mb-4" href="/dev/release/release_tagging/">

...
The handling of language files was re-architected in Zen Cart 1.5.8 to deal with new PHP 8 behavior.  Documents in this folder refer to Zen Cart 1.5.8 and above.  If you need information on how older versions worked, please see [Pre 1.5.8 Language Files](/dev/languages/legacy/).

---
title: Adding Configuration Values to a Module
description: Adding module configuration values without requiring remove and reinstall
weight: 40
aliases:
  - /dev/modules/adding_config/
---

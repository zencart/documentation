---
title: Encapsulated Plugin SQL Installation
description: Using SQL files and installer logic in encapsulated plugins
aliases:
  - /dev/plugins/encapsulated/sql_installation/
weight: 40
layout: docs
---

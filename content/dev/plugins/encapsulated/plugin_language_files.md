---
title: Encapsulated Plugin Installer Language Files
description: Adding installer language files to encapsulated plugins
aliases:
  - /dev/plugins/encapsulated/plugin_language_files/
weight: 20
layout: docs
---

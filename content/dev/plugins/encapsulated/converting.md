---
title: Converting a Plugin to the Encapsulated Architecture
description: Converting an older plugin to the encapsulated plugin architecture
aliases:
  - /dev/plugins/encapsulated/converting/
weight: 80
layout: docs
type: codepage
---
...
Create a [manifest file](/dev/plugins/encapsulated/manifests/). In our example, this will be placed in 
...
Create an [installer script](/dev/plugins/encapsulated/installer_classes/). 
...
required by the plugin, you can use [plain SQL files](/dev/plugins/encapsulated/sql_installation/).  

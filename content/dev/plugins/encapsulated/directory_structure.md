---
title: Encapsulated Plugin Directory Structure
description: Directory layout and naming conventions for encapsulated plugins
aliases:
  - /dev/plugins/encapsulated/directory_structure/
weight: 1 
layout: docs
---
...
2. The `Installer` folder is optional; you can embed the installation logic in your plugin if you prefer.  See [Installer Classes](/dev/plugins/encapsulated/installer_classes/) and [Plugin SQL Installation](/dev/plugins/encapsulated/sql_installation/) for details on using the `Installer` folder. 

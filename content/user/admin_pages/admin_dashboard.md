...
- You may modify the position of each widget on the screen, or delete widgets that are not useful to you. 
  - In Zen Cart 2.0.1 and above, you may customize the dashboard by modifying the `$widgets` array created in `admin/index_dashboard.php` using the [notifier](/dev/architecture/notifiers/) `NOTIFY_ADMIN_DASHBOARD_WIDGETS`.
...
- If you have specific things you'd like to monitor on your site, you can build your own widget.  See [building an admin widget](/dev/admin/widget/) for details. 

...
<div class='indent'>If you wish to have email messages archived/stored when sent, set this to "true".

<br />

To view the email archive that is created when this flag is set to true, 
use the <span> [Email Archive Manager](/user/email/email_archive_manager/)</span>.

...
Encapsulated plugins have been supported in Zen Cart since version 1.5.7, as a way to make plugin installation and maintenance easier for end users.  Developers may learn more by reading [the encapsulated plugin documentation](/dev/plugins/encapsulated/).

...
A link to the About Us page may optionally be displayed in the [Information Sidebox](/user/sideboxes/information_sidebox/). In 1.5.8 and above, use the [site specific overrides](/user/customizing/site_specific_overrides/) file.  Prior to this, use the instructions in 

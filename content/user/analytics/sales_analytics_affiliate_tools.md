...
## Advanced Use  
Advanced programmers might choose programmatic hooks instead of JavaScript callbacks, by invoking the [notifier system](/dev/architecture/notifiers/). This involves hooking 

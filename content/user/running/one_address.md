---
title: Ensuring shipping and billing addresses match
description: Limiting the address book to one address 
category: running 
weight: 10 
---

Some stores want to force the shipping and billing addresses to be the same to limit fraud risk. 

...
**rua=`mailto:mymailbox\@mydomain.com`\:** This specifies the email address where aggregate DMARC reports should be sent.

**ruf=`mailto:mymailbox\@mydomain.com`\:** This specifies the email address where forensic DMARC reports should be sent.

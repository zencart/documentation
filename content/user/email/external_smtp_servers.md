...
- In Zen Cart set your SMTPAUTH Password to your mailbox password which you use to login to the account in Office365
...
- paste that password into your Zen Cart's SMTP Password field instead of the usual password you use to login to the mailbox

...
- Release - Zen Cart Releases are divided into major releases (whose names do not contain alphabetic characters) and patch releases (whose names do contain alphabetic characters).  For example, 1.5.7 and 1.5.8 are minor releases, whereas 1.5.7c and 1.5.8a are patch releases.  See [Release History](/user/about_us/release_history/). 

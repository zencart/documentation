...
- Admin: The plugin formerly known as [Mod List](https://www.zen-cart.com/downloads.php?do=file&id=2039) is now included in the core and named "System Inspection."  It is an [encapsulated plugin](/dev/plugins/encapsulated/), so it can be installed using Admin > Modules > Plugin Manager.
